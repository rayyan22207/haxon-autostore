      ...
      <div class="relative">
        ...
        >
          ...
          >
            ...
            <div
              class="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,0,0.92)_0%,rgba(0,0,0,0.58)_42%,rgba(0,0,0,0.08)_100%)]"
            ></div>
            ...
            <div class="relative flex h-full flex-col justify-between p-6">
              ...
              <p
                class="inline-flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.16em] text-white/75 transition group-hover:text-white"
              >
                Shop Now
